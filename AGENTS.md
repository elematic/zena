...
10. **Multi-Return Values & Zero-Allocation Iteration**:
    ...
    - **Inline Tuple Types** (`(T1, T2)`): ✅ Parser & Checker COMPLETED
      ...
      - Checker: Add `InlineTupleType` to type system. ✅
      - Checker: Validate inline tuples only in return position (not first-class). ✅
