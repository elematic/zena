...
| `emit.zena`             | SSA destruction: stack scheduling (`#pushValue` discipline), block-param copy coalescing, domtree stackifier, terminator streaming, init-discipline non-null local typing (dry pass + validator replay, ir.md §12.1).                                                                                                      |
